...
public struct Polyline {
    ...
    /// Mk polyline.
    /// - Parameters:
    ///   - MKPolyline?: Parameter description
    ...
    public init(locations: [CLLocation], levels: [UInt32]? = nil, precision: Double = 1e5) {
        ...
        /// Coordinates: coordinates, levels: levels, precision:precision
...
/// Extract next chunk.
/// - Parameters:
///   - encodedString: inout String.UnicodeScalarView
/// - Returns: String
/// - Throws: Error if operation fails
